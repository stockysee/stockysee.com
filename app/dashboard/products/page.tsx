...
export default function ProductsOverviewPage() {
  return (
    <div className="h-full min-h-[70vh] flex flex-col items-center justify-center p-8">
      ...
      >
        <div className="w-20 h-20 rounded-[2rem] bg-blue-600/10 flex items-center justify-center text-blue-600 mx-auto mb-8 animate-pulse">
        ...
        <p className="text-zinc-500 font-bold tracking-widest text-xs uppercase">Halaman Overview Produk Sedang Dalam Pengembangan</p>
