                      ...
                      <div className="p-4 space-y-5">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <button
                              onClick={() => handleWidgetClick('COLUMN')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'COLUMN')}
                            ...
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <Columns className="w-4 h-4 text-blue-400 group-hover:text-blue-300" />
                              </div>
                            ...
                            <button
                              ...
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'GRID')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <LayoutGrid className="w-4 h-4 text-blue-400 group-hover:text-blue-300" />
                              </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                              onClick={() => handleWidgetClick('HEADING')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'HEADING')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <Type className="w-4 h-4 text-zinc-400 group-hover:text-white" />
                              </div>
                            ...
                            <button
                              onClick={() => handleWidgetClick('TEXT')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'TEXT')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <AlignLeft className="w-4 h-4 text-zinc-400 group-hover:text-white" />
                              </div>
                            ...
                            <button
                              onClick={() => handleWidgetClick('IMAGE')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'IMAGE')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                            ...
                            <button
                              onClick={() => handleWidgetClick('BUTTON')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'BUTTON')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <MousePointerClick className="w-4 h-4 text-zinc-400 group-hover:text-white" />
                              </div>
                            ...
                            <button
                              onClick={() => handleWidgetClick('DIVIDER')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'DIVIDER')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <SeparatorHorizontal className="w-4 h-4 text-zinc-400 group-hover:text-white" />
                              </div>
                            ...
                            <button
                              onClick={() => handleWidgetClick('BADGE')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'BADGE')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                            ...
                            <button
                              onClick={() => handleWidgetClick('GALLERY')}
                              draggable="true"
                              onDragStart={(e) => handleWidgetDragStart(e, 'GALLERY')}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                              <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-zinc-700 flex items-center justify-center transition-colors">
                                <LayoutGrid className="w-4 h-4 text-zinc-400 group-hover:text-white" />
                              </div>
                        ...
                        <div className="space-y-2 pt-2 border-t border-zinc-800/60">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                              onClick={() => {
                                console.log("[Sidebar] Clicked CATEGORY_LIST widget button");
                                handleWidgetClick('CATEGORY_LIST');
                              }}
                              draggable="true"
                              onDragStart={(e) => {
                                console.log("[Sidebar] Drag started CATEGORY_LIST widget");
                                handleWidgetDragStart(e, 'CATEGORY_LIST');
                              }}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                            ...
                            <button
                              onClick={() => {
                                console.log("[Sidebar] Clicked PRODUCT_LIST widget button");
                                handleWidgetClick('PRODUCT_LIST');
                              }}
                              draggable="true"
                              onDragStart={(e) => {
                                console.log("[Sidebar] Drag started PRODUCT_LIST widget");
                                handleWidgetDragStart(e, 'PRODUCT_LIST');
                              }}
                              onDragEnd={handleWidgetDragEnd}
                              className="p-3 bg-[#18181b] hover:bg-zinc-800/80 border border-zinc-800 hover:border-zinc-700 rounded-xl flex flex-col items-center gap-1.5 transition-all text-zinc-100 hover:text-white hover:-translate-y-[2px] shadow-sm active:scale-95 group cursor-grab"
                            >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-2">
                            ...
                            <button
                              onClick={() => handleInsertHeroTemplate()}
                              className="w-full p-3 bg-gradient-to-r from-zinc-900 to-zinc-950 hover:from-zinc-850 hover:to-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-xl flex items-center gap-3 transition-all text-zinc-100 hover:-translate-y-[2.5px] shadow-sm group/btn"
                            >
                              <div className="w-10 h-10 rounded-xl bg-blue-600 text-white font-extrabold text-[12px] shadow-inner flex items-center justify-center shrink-0">
                                HERO
                              </div>
                            ...
                            <button
                              onClick={() => handleInsertFeaturesTemplate()}
                              className="w-full p-3 bg-gradient-to-r from-zinc-900 to-zinc-950 hover:from-zinc-850 hover:to-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-xl flex items-center gap-3 transition-all text-zinc-100 hover:-translate-y-[2.5px] shadow-sm group/btn"
                            >
                              <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white font-extrabold text-[12px] shadow-inner flex items-center justify-center shrink-0">
                                GRID
                              </div>
                              <div className="text-left leading-tight">
...
className="w-4 h-4 object-contain"
                                  ...
                                  <div className="space-y-5">
                                    ...
                                    <div className="space-y-2">
                                      ...
                                      <div className="relative w-full aspect-[2/1] rounded-xl overflow-hidden border border-zinc-800/80 bg-[#1a1a1f] transition-all group">
                                        ...
                                        />
                                        <img
                                          src={activeElement.config.url || 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&auto=format&fit=crop&q=60'}
                                          alt="Pilih Gambar"
                                              ...
                                              <>
                                                ...
                                                <div className="flex flex-col items-stretch py-1.5 gap-1">
                                                  ...
                                                  <div className="flex gap-0.5 bg-zinc-950 p-0.5 rounded border border-zinc-800 w-full">
                                                    {[
                                                      { v: 'horizontal', label: '→', title: 'Row' },
                                                      { v: 'vertical', label: '↓', title: 'Column' },
                                                      { v: 'row-reverse', label: '←', title: 'Row Reverse' },
                                                      { v: 'col-reverse', label: '↑', title: 'Column Reverse' },
                                                    ].map(opt => (
                                                      <button
                                                        key={opt.v}
                                                        type="button"
                                                ...
                                                <div className="flex flex-col items-stretch py-1.5 gap-1">
                                                  ...
                                                  <div className="flex gap-0.5 bg-zinc-950 p-0.5 rounded border border-zinc-800 w-full">
                                                    {[
                                                      { v: 'flex-start', l: '├─', t: 'Start' },
                                                      { v: 'center', l: '─┼─', t: 'Center' },
                                                      { v: 'flex-end', l: '─┤', t: 'End' },
                                                      { v: 'space-between', l: '├─┤', t: 'Space Between' },
                                                      { v: 'space-around', l: '░┼░', t: 'Space Around' },
                                                      { v: 'space-evenly', l: '═┼═', t: 'Space Evenly' },
                                                    ].map(opt => (
                                                      <button
                                                        key={opt.v}
                                                        type="button"
                                                        ...
                                                        className={`flex-1 h-7 flex items-center justify-center text-[10px] font-black transition-all rounded ${(activeElement.config.justifyContent || 'flex-start') === opt.v
                                                          ? 'bg-zinc-800 text-white border border-zinc-700 shadow-sm'
                                                          : 'text-zinc-500 hover:bg-zinc-900/40 hover:text-zinc-300'
                                                          }`}
                                                      >
                                                  ...
                                                  <div className="flex gap-0.5 bg-zinc-950 p-0.5 rounded border border-zinc-800 w-full">
                                                    {[
                                                      ...
                                                      <button
                                                        ...
                                                        className={`flex-1 h-7 flex items-center justify-center text-xs font-black transition-all rounded ${(activeElement.config.alignItems || 'stretch') === opt.v
                                                          ? 'bg-zinc-800 text-white border border-zinc-700 shadow-sm'
                                                          : 'text-zinc-500 hover:bg-zinc-900/40 hover:text-zinc-300'
                                                          }`}
                                                      >
                                  ...
                                  {activeEditorTab === 'style' && (
                                    <div className="space-y-4 animate-in fade-in slide-in-from-top-1 duration-200">
                                      ...
                                      <div className="space-y-3">
                                        <button
                                          type="button"
                                          onClick={() => setEditorCollapse(prev => ({ ...prev, latarBelakangColumn: !(prev.latarBelakangColumn ?? true) }))}
                                          className="w-full flex items-center gap-1.5 py-2 text-zinc-100 font-bold text-[11px] uppercase tracking-wider text-left hover:text-white transition-colors"
                                        >
                                          {(editorCollapse.latarBelakangColumn ?? true) ? <ChevronDown className="w-3.5 h-3.5 text-zinc-400 shrink-0" /> : <ChevronRight className="w-3.5 h-3.5 text-zinc-400 shrink-0" />}
                                          <span>Latar Belakang</span>
                                        </button>

                                        {(editorCollapse.latarBelakangColumn ?? true) && (
                                          <div className="space-y-3.5 animate-in fade-in duration-200">
                                            {/* Warna Latar */}
                                            <div className="space-y-1">
                                              <label className="text-[9px] font-bold text-zinc-400 uppercase">Warna Latar</label>
                                              <div className="flex gap-2 items-center">
                                                <input
                                                  type="color"
                                                  value={activeElement.config.bgColor || '#ffffff'}
                                                  onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { bgColor: e.target.value })}
                                                  className="w-10 h-8 rounded bg-transparent border border-zinc-800 cursor-pointer overflow-hidden"
                                                />
                                                <input
                                                  type="text"
                                                  value={activeElement.config.bgColor || '#ffffff'}
                                                  onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { bgColor: e.target.value })}
                                                  className="flex-1 h-8 px-2.5 rounded text-xs bg-zinc-950 text-zinc-100 border border-zinc-800 focus:border-zinc-700 outline-none font-medium"
                                                />
                                              </div>
                                            </div>
                                            ...
                                            {/* Gambar Latar */}
                                            <div className="space-y-1">
                                              <label className="text-[9px] font-bold text-zinc-400 uppercase">Gambar Latar</label>
                                              <div className="relative w-full aspect-[2/1] rounded-lg overflow-hidden border border-zinc-800/80 bg-[#1a1a1f] transition-all group cursor-pointer">
                                                <input type="file" id="hidden-bg-file-col" accept="image/*" className="hidden" disabled={isUploading} onChange={async (e) => { const f = e.target.files?.[0]; if (!f) return; const url = await handleUploadImage(f); if (url) handleUpdateElement(editingSection.id, activeElement.id, { bgImageUrl: url }); e.target.value = ''; }} />
                                                ...
                                                <div className="absolute inset-x-0 bottom-0 bg-black/85 p-2 opacity-0 group-hover:opacity-100 flex items-center gap-1.5 transition-all duration-200 z-20">
                                                  <button type="button" onClick={() => { openMediaModal((url) => { handleUpdateElement(editingSection.id, activeElement.id, { bgImageUrl: url }); }, "image"); }} className="px-2 py-1 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-[10px] text-zinc-300 hover:text-white rounded-md font-bold transition-all flex items-center gap-1 cursor-pointer">
                                                    <ImageIcon className="w-3 h-3 text-zinc-400" />
                                                    <span>Buka media</span>
                                                  </button>
                                                  <label htmlFor="hidden-bg-file-col" className="px-2 py-1 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-[10px] text-zinc-300 hover:text-white rounded-md font-bold transition-all flex items-center gap-1 cursor-pointer">
                                                    <Upload className="w-3 h-3 text-zinc-400" />
                                                    <span>Upload</span>
                                                  </label>
                                                </div>
                                                {activeElement.config.bgImageUrl && (
                                                  <button type="button" onClick={async (e) => { e.preventDefault(); e.stopPropagation(); await handleDeleteImage(activeElement.config.bgImageUrl); handleUpdateElement(editingSection.id, activeElement.id, { bgImageUrl: '' }); }} className="absolute top-1.5 right-1.5 w-6 h-6 rounded-md bg-red-600/90 hover:bg-red-700 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all z-30 cursor-pointer" title="Hapus gambar latar">
                                            ...
                                            {activeElement.config.bgImageUrl && (
                                              <div className="space-y-1">
                                                <div className="flex justify-between items-center">
                                                  <span className="text-[9px] font-bold text-zinc-400 uppercase">Overlay Opacity</span>
                                                  <span className="text-[9px] font-bold text-zinc-400">{Math.round((activeElement.config.overlay ?? 0.3) * 100)}%</span>
                                                </div>
                                                <input
                                                  type="range"
                                                  min="0"
                                                  max="100"
                                                  value={Math.round((activeElement.config.overlay ?? 0.3) * 100)}
                                                  onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { overlay: Number(e.target.value) / 100 })}
                                                  className="w-full accent-zinc-100 bg-zinc-900 h-1 rounded-lg cursor-pointer"
                                                />
                                              </div>
                                            )}
                                          </div>
                                      ...
                                      <div className="space-y-3">
                                        <button
                                          type="button"
                                          onClick={() => setEditorCollapse(prev => ({ ...prev, perbatasanColumn: !(prev.perbatasanColumn ?? true) }))}
                                          className="w-full flex items-center gap-1.5 py-2 text-zinc-100 font-bold text-[11px] uppercase tracking-wider text-left hover:text-white transition-colors"
                                        >
                                          {(editorCollapse.perbatasanColumn ?? true) ? <ChevronDown className="w-3.5 h-3.5 text-zinc-400 shrink-0" /> : <ChevronRight className="w-3.5 h-3.5 text-zinc-400 shrink-0" />}
                                          <span>Perbatasan & Bayangan</span>
                                        </button>

                                        {(editorCollapse.perbatasanColumn ?? true) && (
                                          <div className="space-y-3.5 animate-in fade-in duration-200">
                                            {/* Border Radius */}
                                            <div className="space-y-1">
                                              <div className="flex justify-between items-center">
                                                <span className="text-[9px] font-bold text-zinc-400 uppercase">Sudut Radius</span>
                                                <span className="text-[9px] font-bold text-zinc-400">{activeElement.config.borderRadius ?? 0}px</span>
                                              </div>
                                            ...
                                            {/* Border Width & Color */}
                                            <div className="space-y-2 py-1">
                                              <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Tebal & Warna Border</span>
                                              <div className="flex gap-2">
                                                <input
                                                  type="number"
                                                  min="0"
                                                  ...
                                                  className="w-16 h-8 text-center text-xs font-bold bg-zinc-950 text-zinc-100 border border-zinc-800 rounded focus:border-zinc-700 outline-none font-medium"
                                                />
                                                <input
                                                  type="color"
                                                  value={activeElement.config.borderColor || '#e2e8f0'}
                                                  onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { borderColor: e.target.value })}
                                                  className="flex-1 h-8 rounded bg-transparent border border-zinc-800 cursor-pointer overflow-hidden"
                                                />
                                              </div>
                                            </div>
                                            ...
                                            {/* Box Shadow */}
                                            <div className="space-y-1">
                                              <span className="text-[9px] font-bold text-zinc-400 uppercase">Efek Bayangan (Shadow)</span>
                                              <div className="flex gap-0.5 bg-zinc-950 p-0.5 rounded border border-zinc-800">
                                                {[
                                                  { v: 'none', l: 'None' },
                                                  { v: 'soft', l: 'Soft' },
                                                  { v: 'medium', l: 'Medium' },
                                                  ...
                                                  <button
                                                    key={opt.v}
                                                    type="button"
                                                    onClick={() => handleUpdateElement(editingSection.id, activeElement.id, { boxShadow: opt.v })}
                                                    className={`flex-1 h-7 flex items-center justify-center text-xs font-bold transition-all rounded ${(activeElement.config.boxShadow || 'none') === opt.v
                                                      ? 'bg-zinc-800 text-white border border-zinc-700 shadow-sm'
                                                      : 'text-zinc-500 hover:bg-zinc-900/40 hover:text-zinc-300'
                                                      }`}
                                                  >
                            ...
                            {activeEditorTab === 'layout' && activeElement.type === 'BRANDING' && (
                              <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Ukuran Font: {activeElement.config.fontSize ?? 16}px</span>
                                  <input type="range" min="12" max="32" value={activeElement.config.fontSize ?? 16} onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { fontSize: Number(e.target.value) })} className="w-full accent-blue-500 h-1 bg-zinc-800 rounded-lg cursor-pointer appearance-none" />
                                </div>
                            ...
                            {activeEditorTab === 'layout' && activeElement.type === 'MENU' && (
                              <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Ukuran Font: {activeElement.config.fontSize ?? 13}px</span>
                                  <input type="range" min="10" max="24" value={activeElement.config.fontSize ?? 13} onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { fontSize: Number(e.target.value) })} className="w-full accent-blue-500 h-1 bg-zinc-800 rounded-lg cursor-pointer appearance-none" />
                                </div>
                            ...
                            {activeEditorTab === 'layout' && activeElement.type === 'CART' && (
                              <div className="space-y-4">
                                <span className="text-[9px] font-black uppercase tracking-widest text-zinc-400">Styling Tombol Keranjang</span>

                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Teks Tombol</span>
                                  <input type="text" value={activeElement.config.text || 'Keranjang'} onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { text: e.target.value })} className="w-full p-2.5 rounded-lg text-[11px] font-bold bg-zinc-950 text-white border border-zinc-800 focus:border-blue-500 outline-none" />
                                </div>

                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Latar Tombol</span>
                                  <input type="color" value={activeElement.config.bgColor || '#18181B'} onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { bgColor: e.target.value })} className="w-full h-8 rounded-lg bg-zinc-950 border border-zinc-800 cursor-pointer p-0.5" />
                                </div>

                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Teks Tombol</span>
                                  <input type="color" value={activeElement.config.textColor || '#FFFFFF'} onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { textColor: e.target.value })} className="w-full h-8 rounded-lg bg-zinc-950 border border-zinc-800 cursor-pointer p-0.5" />
                                </div>

                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Radius: {activeElement.config.borderRadius ?? 8}px</span>
                                  <input type="range" min="0" max="24" value={activeElement.config.borderRadius ?? 8} onChange={(e) => handleUpdateElement(editingSection.id, activeElement.id, { borderRadius: Number(e.target.value) })} className="w-full accent-blue-500 h-1 bg-zinc-800 rounded-lg cursor-pointer appearance-none" />
                                </div>

                                <div className="space-y-1">
                                  <span className="text-[8px] font-bold uppercase text-zinc-500">Perataan Tombol</span>
                                  <div className="flex gap-1">
                                    {(['left', 'center', 'right'] as const).map(a => (
                                      <button key={a} onClick={() => handleUpdateElement(editingSection.id, activeElement.id, { align: a })}
                                        className={`flex-1 py-1.5 rounded-lg text-[8px] font-bold uppercase transition-all ${(activeElement.config.align || 'right') === a ? 'bg-blue-600 text-white border-transparent' : 'bg-zinc-950 text-zinc-400 border border-zinc-800 hover:bg-zinc-900'}`}
                                      >{a === 'left' ? 'Kiri' : a === 'center' ? 'Tengah' : 'Kanan'}</button>
                                    ))}
                                  </div>
                                </div>
                              ...
                              <div className="space-y-4">
                                ...
                                {activeSubFocus === 'header_title' && (
                                  <div className="space-y-4 animate-in fade-in duration-200">
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Judul</span>
                                      <div className="flex gap-2">
                                        <input
                                          type="color"
                                          value={activeElement.config.titleColor || '#18181B'}
                                          onChange={(e) => {
                                            const val = e.target.value;
                                            console.log(`[Editor CATEGORY_LIST] Mengubah warna judul daftar kategori ke: "${val}"`);
                                            handleUpdateElement(editingSection.id, activeElement.id, { titleColor: val });
                                          }}
                                ...
                                {activeSubFocus === 'title' && (
                                  <div className="space-y-4 animate-in fade-in duration-200">
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Teks Kategori</span>
                                      <div className="flex gap-2">
                                        <input
                                          type="color"
                                          ...
                                          onChange={(e) => {
                                            const val = e.target.value;
                                            console.log(`[Editor CATEGORY_LIST] Mengubah warna teks nama kategori ke: "${val}"`);
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500 flex justify-between">
                                        ...
                                        <span className="text-blue-400 font-extrabold">{activeElement.config.fontSize ?? 12}px</span>
                                      </span>
                                      <input
                                        type="range"
                                        min="10"
                                        max="24"
                                        value={activeElement.config.fontSize ?? 12}
                                        onChange={(e) => {
                                          const val = Number(e.target.value);
                                          console.log(`[Editor CATEGORY_LIST] Mengubah ukuran font nama kategori ke: ${val}px`);
                                          handleUpdateElement(editingSection.id, activeElement.id, { fontSize: val });
                                        }}
                                        className="w-full accent-blue-500 h-1 bg-zinc-800 rounded-lg cursor-pointer appearance-none"
                                      />
                              ...
                              <div className="space-y-4">
                                    ...
                                    <div className="space-y-1">
                                      ...
                                      <div className="flex gap-2">
                                        <input
                                          ...
                                          onChange={(e) => {
                                            const val = e.target.value;
                                            console.log(`[Editor PRODUCT_LIST] Mengubah warna judul ke: "${val}"`);
                                            handleUpdateElement(editingSection.id, activeElement.id, { titleColor: val });
                                          }}
                                          className="w-10 h-8 rounded bg-zinc-950 border border-zinc-800 cursor-pointer p-0.5"
                                        />
                                ...
                                {activeSubFocus === 'card' && (
                                  <div className="space-y-4 animate-in fade-in duration-200">
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Latar Kartu</span>
                                      <div className="flex gap-2">
                                        <input
                                          type="color"
                                ...
                                {activeSubFocus === 'title' && (
                                  <div className="space-y-4 animate-in fade-in duration-200">
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Teks Nama</span>
                                      <div className="flex gap-2">
                                        <input
                                          type="color"
                                          value={activeElement.config.productNameColor || '#1f2937'}
                                          onChange={(e) => {
                                            const val = e.target.value;
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500 flex justify-between">
                                        ...
                                        <span className="text-blue-400 font-extrabold">{activeElement.config.productNameSize ?? 13}px</span>
                                      </span>
                                      <input
                                        type="range"
                                        min="10"
                                        max="20"
                                        value={activeElement.config.productNameSize ?? 13}
                                        onChange={(e) => {
                                          const val = Number(e.target.value);
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Ketebalan Font Nama</span>
                                      <select
                                        value={activeElement.config.productNameWeight || '600'}
                                        onChange={(e) => {
                                          const val = e.target.value;
                                      ...
                                      >
                                        ...
                                        <option value="500">Medium (500)</option>
                                        <option value="600">Semibold (600)</option>
                                        <option value="750">Bold (750)</option>
                                        <option value="900">Black (900)</option>
                                      </select>
                                    </div>

                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Perataan Teks Nama</span>
                                      <select
                                        value={activeElement.config.productNameAlign || 'left'}
                                        onChange={(e) => {
                                          const val = e.target.value;
                                          console.log(`[Editor PRODUCT_LIST] Mengubah productNameAlign ke: "${val}"`);
                                          handleUpdateElement(editingSection.id, activeElement.id, { productNameAlign: val });
                                        }}
                                        className="w-full p-2.5 rounded-lg text-xs bg-zinc-950 text-zinc-100 border border-zinc-800 focus:border-blue-500 outline-none cursor-pointer font-bold"
                                      >
                                ...
                                {activeSubFocus === 'price' && (
                                  <div className="space-y-4 animate-in fade-in duration-200">
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Harga Utama</span>
                                      <div className="flex gap-2">
                                        <input
                                          type="color"
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500 flex justify-between">
                                        <span>Ukuran Font Harga Utama</span>
                                        <span className="text-blue-400 font-extrabold">{activeElement.config.priceSize ?? 14}px</span>
                                      </span>
                                      <input
                                        type="range"
                                        min="10"
                                        max="22"
                                        value={activeElement.config.priceSize ?? 14}
                                        onChange={(e) => {
                                          const val = Number(e.target.value);
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Ketebalan Font Harga</span>
                                      <select
                                        value={activeElement.config.priceWeight || '900'}
                                        onChange={(e) => {
                                          const val = e.target.value;
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Harga Coret</span>
                                      <div className="flex gap-2">
                                        <input
                                          type="color"
                                          value={activeElement.config.discountPriceColor || '#d1d5db'}
                                          onChange={(e) => {
                                            const val = e.target.value;
                                    ...
                                    <div className="space-y-1">
                                      <span className="text-[8px] font-bold uppercase text-zinc-500 flex justify-between">
                                        <span>Ukuran Font Harga Coret</span>
                                        <span className="text-blue-400 font-extrabold">{activeElement.config.discountPriceSize ?? 10}px</span>
                                      </span>
                                      <input
                                        type="range"
                                        min="8"
                                        max="16"
                                        value={activeElement.config.discountPriceSize ?? 10}
                                        onChange={(e) => {
                                          const val = Number(e.target.value);
                                    ...
                                    {(activeElement.config.showStock !== false) && (
                                      <div className="space-y-1 pt-1.5 animate-in fade-in duration-200">
                                        <span className="text-[8px] font-bold uppercase text-zinc-500">Warna Label Stok</span>
                                        <div className="flex gap-2">
                                          <input
                                            type="color"
                                            value={activeElement.config.stockColor || '#9ca3af'}
                                            onChange={(e) => {
                                              const val = e.target.value;
                                    ...
                                    {(activeElement.config.showStock !== false) && (
                                      <div className="space-y-1">
                                        <span className="text-[8px] font-bold uppercase text-zinc-500 flex justify-between">
                                          <span>Ukuran Font Label Stok</span>
                                          <span className="text-blue-400 font-extrabold">{activeElement.config.stockSize ?? 9}px</span>
                                        </span>
                                        <input
                                          type="range"
                                          min="7"
                                          max="14"
                                          value={activeElement.config.stockSize ?? 9}
                                          onChange={(e) => {
                                            const val = Number(e.target.value);
                                  ...
                                  {(editorCollapse.strukturSection ?? true) && (
                                    <div className="space-y-3.5 animate-in fade-in duration-200">
                                      ...
                                      <div className="flex justify-between items-center py-1">
                                        ...
                                        <select
                                          value={editingSection.config.layout || 'vertical'}
                                          onChange={(e) => {
                              ...
                              <div className="space-y-4 animate-in fade-in slide-in-from-top-1 duration-200">
                                ...
                                <div className="space-y-3">
                                  ...
                                  {(editorCollapse.latarBelakangSection ?? true) && (
                                    <div className="space-y-4 animate-in fade-in duration-200">
                                      {/* Warna Latar */}
                                      <div className="space-y-2 py-1">
                                        <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Warna Latar</span>
                                        <div className="flex gap-2">
                                          <input type="color" value={editingSection.config.bgColor || '#ffffff'} onChange={(e) => updateLocalSection({ ...editingSection, config: { ...editingSection.config, bgColor: e.target.value } })} className="w-10 h-8 rounded bg-transparent border border-zinc-800 cursor-pointer overflow-hidden" />
                                      ...
                                      {/* Gambar Latar */}
                                      <div className="space-y-2 py-1">
                                        <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Gambar Latar</span>
                                        <div className="relative w-full aspect-[2/1] rounded-lg overflow-hidden border border-zinc-800/80 bg-[#1a1a1f] transition-all group cursor-pointer">
                                          <input type="file" id="hidden-bg-file-sec" accept="image/*" className="hidden" disabled={isUploading} onChange={async (e) => { const f = e.target.files?.[0]; if (!f) return; const url = await handleUploadImage(f); if (url) updateLocalSection({ ...editingSection, config: { ...editingSection.config, bgImageUrl: url } }); e.target.value = ''; }} />
                                          ...
                                          <div className="absolute inset-x-0 bottom-0 bg-black/85 p-2 opacity-0 group-hover:opacity-100 flex items-center gap-1.5 transition-all duration-200 z-20">
                                            ...
                                            <label htmlFor="hidden-bg-file-sec" className="px-2 py-1 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-[10px] text-zinc-300 hover:text-white rounded-md font-bold transition-all flex items-center gap-1 cursor-pointer">
                                              <Upload className="w-3 h-3 text-zinc-400" />
                                              <span>Upload</span>
                                            </label>
                                          </div>
                                        ...
                                        {editingSection.config.bgImageUrl && (
                                          <div className="space-y-2 mt-2 p-2 bg-zinc-950 rounded border border-zinc-800">
                                            <div className="flex justify-between items-center">
                                              <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Overlay Opacity</span>
                                              <span className="text-xs font-bold text-zinc-300">{Math.round((editingSection.config.overlay ?? 0.3) * 100)}%</span>
                                            </div>
                                            <input type="range" min="0" max="100" value={Math.round((editingSection.config.overlay ?? 0.3) * 100)} onChange={(e) => updateLocalSection({ ...editingSection, config: { ...editingSection.config, overlay: Number(e.target.value) / 100 } })} className="w-full accent-zinc-100 bg-zinc-900 h-1 rounded-lg cursor-pointer" />
                                          </div>
                                        )}
                                      </div>
                                ...
                                <div className="space-y-3">
                                  <button
                                    ...
                                    className="w-full flex items-center gap-1.5 py-2 text-zinc-100 font-bold text-[11px] uppercase tracking-wider text-left hover:text-white transition-colors"
                                  >
                                    {(editorCollapse.perbatasanSection ?? true) ? <ChevronDown className="w-3.5 h-3.5 text-zinc-400 shrink-0" /> : <ChevronRight className="w-3.5 h-3.5 text-zinc-400 shrink-0" />}
                                    <span>Perbatasan & Kelengkungan</span>
                                  </button>
                                  ...
                                  {(editorCollapse.perbatasanSection ?? true) && (
                                    <div className="space-y-4 animate-in fade-in duration-200">
                                      ...
                                      <div className="space-y-2 py-1">
                                        <div className="flex justify-between items-center">
                                          <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Sudut Radius</span>
                                          <div className="flex items-center gap-1.5">
                                            <span className="text-[10px] font-bold text-zinc-300">{editingSection.config.borderRadius ?? 0}</span>
                                            <span className="text-[9px] text-zinc-500 font-bold">px</span>
                                          </div>
                                        </div>
                                        <div className="flex gap-3 items-center">
                                          <input
                                            ...
                                            min="0"
                                            max="80"
                                            value={editingSection.config.borderRadius ?? 0}
                                            onChange={(e) => updateLocalSection({ ...editingSection, config: { ...editingSection.config, borderRadius: Number(e.target.value) } })}
                                            className="flex-1 accent-zinc-100 bg-zinc-950 h-1 rounded-lg cursor-pointer"
                                          />
                                          <input
                                            type="number"
                                      ...
                                      <div className="space-y-2 py-1">
                                        ...
                                        <div className="flex gap-2">
                                          <input
                                            ...
                                            min="0"
                                            max="20"
                                            value={editingSection.config.borderWidth ?? 0}
                                            onChange={(e) => updateLocalSection({ ...editingSection, config: { ...editingSection.config, borderWidth: Number(e.target.value) } })}
                                            placeholder="0"
                                            className="w-16 h-8 text-center text-xs font-bold bg-zinc-950 text-zinc-100 border border-zinc-800 rounded focus:border-zinc-700 outline-none font-medium"
                                          />
                                          <input
                                            type="color"
                                            value={editingSection.config.borderColor || '#E4E4E7'}
                                            onChange={(e) => updateLocalSection({ ...editingSection, config: { ...editingSection.config, borderColor: e.target.value } })}
                                            className="flex-1 h-8 rounded bg-transparent border border-zinc-800 cursor-pointer overflow-hidden"
                                          />
                                        </div>
                                      </div>
                                      ...
                                      {/* Box Shadow */}
                                      <div className="space-y-2 py-1">
                                        <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Bayangan (Shadow)</span>
                                        <div className="flex gap-0.5 bg-zinc-950 p-0.5 rounded border border-zinc-800">
                                          {[
                                            { v: 'none', l: 'None' },
                                            { v: 'soft', l: 'Soft' },
                                            ...
                                            <button
                                              key={sh.v}
                                              type="button"
                                              onClick={() => updateLocalSection({ ...editingSection, config: { ...editingSection.config, boxShadow: sh.v } })}
                                              className={`flex-1 h-7 flex items-center justify-center text-xs font-bold transition-all rounded ${(editingSection.config.boxShadow || 'none') === sh.v
                                                ? 'bg-zinc-800 text-white border border-zinc-700 shadow-sm'
                                                : 'text-zinc-500 hover:bg-zinc-900/40 hover:text-zinc-300'
                                                }`}
                                            >
