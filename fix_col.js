...
const sectionStyleStart = lines.findIndex((l, i) => i > 15000 && (l.includes("activeEditorTab === 'style' && (") || l.includes('activeEditorTab === "style" && (')));
...
const columnStyleStart = lines.findIndex((l, i) => i > 2000 && i < 3000 && (l.includes("activeEditorTab === 'style' && (") || l.includes('activeEditorTab === "style" && (')));
