  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-blue-600/30 overflow-x-hidden antialiased">
      ...
      <section className="relative pt-32 pb-32 md:pt-56 md:pb-24 px-6 text-center overflow-hidden">
        {/* GALAXY NEBULA */}
        <div className="galaxy-cloud bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-transparent"></div>
        ...
        <div className="max-w-6xl mx-auto relative z-30">
          ...
          <div className="relative">
            ...
            <h1 className="hidden md:block text-5xl md:text-7xl font-extrabold tracking-[-0.04em] leading-[1.05] mb-6 text-center">
              Bangun Bisnis Anda <br /> Hanya Dalam <span className="text-blue-500">Sekali Klik</span>
            </h1>
            <h1 className="md:hidden text-4xl font-extrabold tracking-[-0.04em] leading-[1.1] mb-6 text-left">
              Bangun Bisnis Anda <br /> Hanya Dalam <br /><span className="text-blue-500">Sekali Klik</span>
            </h1>

            {/* LIGHT SWEEP OVERLAY */}
            <div className="absolute inset-0 pointer-events-none z-10" aria-hidden="true">
              <h1 className="hidden md:block text-5xl md:text-7xl font-extrabold tracking-[-0.04em] leading-[1.05] mb-6 text-center text-transparent bg-clip-text bg-[linear-gradient(110deg,transparent_45%,#00f0ff_50%,transparent_55%)] bg-[length:200%_100%] animate-shimmer">
                Bangun Bisnis Anda <br /> Hanya Dalam <span className="text-transparent">Sekali Klik</span>
              </h1>
              <h1 className="md:hidden text-4xl font-extrabold tracking-[-0.04em] leading-[1.1] mb-6 text-left text-transparent bg-clip-text bg-[linear-gradient(110deg,transparent_45%,#00f0ff_50%,transparent_55%)] bg-[length:200%_100%] animate-shimmer">
                Bangun Bisnis Anda <br /> Hanya Dalam <br /><span className="text-transparent">Sekali Klik</span>
              </h1>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-center md:space-x-20 space-y-8 md:space-y-0">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-[10px] md:text-xs text-zinc-500 font-medium uppercase tracking-[0.2em] mt-1 text-center md:text-left">Telah membantu puluhan pengusaha mengelola toko dan bisnis mereka secara otomatis</p>
            </div>
